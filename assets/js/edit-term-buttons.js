...
function editTermButtons() {
   ...
   document.querySelectorAll('dt.term-local').forEach(item => {
      ...
      term.innerHTML += `<span class="edit-term-buttons">
         <a title="Edit term on GitHub (opens in a new tab)" target="_blank" rel="noopener noreferrer"
            href="https://github.com/${repoInfo.username}/${repoInfo.repo}/blob/${repoInfo.branch}/${pathLocalTerms}"
            class="p-1 edit-term-button btn"
            aria-label="Edit term on GitHub (opens in a new tab)">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" viewBox="0 0 16 16" style="shape-rendering: geometricPrecision;" aria-hidden="true" focusable="false">
         ...
         <a title="View edit history on GitHub (opens in a new tab)" target="_blank" rel="noopener noreferrer"
            ...
            aria-label="View edit history on GitHub (opens in a new tab)">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" viewBox="0 0 16 16" style="shape-rendering: geometricPrecision;" aria-hidden="true" focusable="false">
